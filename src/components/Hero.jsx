    ...
    <section id="home" className="hero">
      ...
      <div className="container hero-container">
        ...
        >
          ...
          <h1 className="hero-title">Realce a sua beleza com a <span>Florbela Viana</span></h1>
          ...
          <div className="hero-buttons">
            <a href="https://wa.me/351969065846" target="_blank" rel="noreferrer" className="btn btn-whatsapp">Agendar pelo WhatsApp</a>
